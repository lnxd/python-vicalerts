...
class FeedClient:
    ...
    def fetch(self, etag: Optional[str] = None) -> Tuple[Optional[GeoJSONFeed], Optional[str], int]:
        """
...
class RetryClient(FeedClient):
    ...
    def fetch_with_retry(self, etag: Optional[str] = None) -> Tuple[Optional[GeoJSONFeed], Optional[str], int]:
