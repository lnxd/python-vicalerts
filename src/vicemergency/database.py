...
class Database:
    ...
    def store_raw_feed(self, feed_data: Dict[str, Any], etag: Optional[str] = None, fetched_at: str = None) -> int:
    ...
    def get_latest_etag(self) -> Optional[str]:
    ...
    def get_raw_feed(self, feed_id: int) -> Optional[Dict[str, Any]]:
    ...
    def upsert_event(self, event_id: int, feed_type: str, source_org: str,
                     category1: Optional[str], category2: Optional[str],
                     timestamp: str) -> None:
    ...
    def add_event_version(self, event_id: int, version_ts: str, status: Optional[str],
                          headline: Optional[str], category: Optional[str],
                          lat: Optional[float], lon: Optional[float],
                          location: Optional[str], size_fmt: Optional[str],
