...
class FeedParser:
    ...
    def parse_and_store(self, feed: GeoJSONFeed, etag: Optional[str] = None) -> Dict[str, int]:
        """
    ...
    def _extract_coordinates(self, feature: Feature) -> Tuple[Optional[float], Optional[float]]:
    ...
    def _extract_headline(self, props) -> Optional[str]:
